...
public class AccountJPanel extends javax.swing.JPanel {
    ...
    public AccountJPanel(JPanel userProcessContainer, UserAccount userAccount, Org organization,
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(155, 231, 224));
        ...
        tblAccount.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {

        }, new String[] { "Agency Name", "Account" }) {
